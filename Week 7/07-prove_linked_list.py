...
class LinkedList:
    ...
    def insert_tail(self, value):
        ...
        if self.head is None:
            ...
            # * Point the tail node to this new node
            self.tail.next = new_node
            # * Set the new node's prev to the old tail
            new_node.prev = self.tail
            # * Make the tail the new end node
            self.tail = new_node
    ...
    def remove_tail(self):
        ...
        if self.head == self.tail:
            ...
            # * Make the 'next' of tail's 'prev' none
        ...
        while curr is not None:
            if curr.data == value:
                ...
                # * Otherwise, then we'll need to manually remove the item
                    ...
                    # change the current's prev's next to the current's next
                    curr.prev.next = curr.next
                    # change the current's next's prev to the current's prev
