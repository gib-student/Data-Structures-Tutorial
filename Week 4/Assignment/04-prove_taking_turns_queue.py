...
class Taking_Turns_Queue:
    ...
    in the queue is displayed and then they are placed back into queue at the end.  Thus,
...
# Defect(s) Found: 
# The enqueue function incorrectly added players to the beginning of the list
...
#print(players)    
# Defect(s) Found:
# The functionality to give a person infinite turns is not included. 
print("=================")
...
players.get_next_person()
# Defect(s) Found:
# I'm not sure if what I'm seeing is an error or not, as what is 
# already happening may already satisfy the requirements. A message
# is displayed when the queue is empty which says "No one
# in the queue", so I'm not sure if this is acceptable or not. 
# To be sure, I will change the message to "Error: The queue is 
# empty."